...
##' 
##' @slot code A character value specifying the metadata element type (such as
##' "SAMPLING_ERROR" or "COMMENT").
##' @slot description A character value holding the extended description of
##' the metadata element.
##' @slot value The character value associated to the metadata element.
##' 
