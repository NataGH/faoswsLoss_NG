...
GFLI_SDG_fun <- function(keys_lower,aggregation,weights,basketN,production){
    # Description:
    #
  ...
  Losses <- timeSeriesDataToBeImputed_5016 #getLossData() 
  ...
  #write.csv(ComBasket, file='LossBasket_top10byctry.csv')
