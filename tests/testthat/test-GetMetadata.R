...
test_that("GetMetadata produces data in the right format",{
  ...
  expected_output <- structure(list(geographicAreaM49 = c("4", "4", "4", "4"), measuredElement = c("5417", 
    ...
    "2005"), Metadata = c("PARAMETER", "COMPUTATION", "PARAMETER", 
    "COMMENT"), Metadata_Language = c("en", "en", "en", "en"), Metadata_Group = c(1L, 
    2L, 3L, 1L), Metadata_Value = c("updateAll = session", "Compute Yield", 
                                                                                                                                                                            "Main dataset Agriculture Production/Agriculture Production on session APR 2015-12-08 11:54:20 (524168)", 
