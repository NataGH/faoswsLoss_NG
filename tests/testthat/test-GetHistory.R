...
test_that("GetHistory processing works",{
  ...
  output <- structure(list(geographicAreaM49 = c("4", "4", "4", "4", "4", 
                      ...
                      2L, 3L, 1L, 1L, 2L, 3L, 1L, 2L, 3L, 1L, 2L, 3L), Metadata_Element = c("PARAMETER", 
                      "COMPUTATION", "PARAMETER", "COMMENT", "PARAMETER", "COMPUTATION", 
                      "PARAMETER", "PARAMETER", "COMPUTATION", "PARAMETER", "PARAMETER", 
                      "COMPUTATION", "PARAMETER"), Metadata_Value = c("updateAll = session", 
                      ...
                      "EndDate", "Metadata", "Metadata_Language", "Metadata_Group", 
                      "Metadata_Element", "Metadata_Value", "Value", "flagObservationStatus", 
